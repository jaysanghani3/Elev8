const Milestones = () => {
  ...
  return (
    <div className="w-11/12 lg:w-9/12 mx-auto grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 my-11 p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] ">
