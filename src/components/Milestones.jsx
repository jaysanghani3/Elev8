const Milestones = () => {
  const data = [
    { title: 'Global Presence', number: 20 },
    { title: 'Team Members', number: 1100 },
    { title: 'Indian States Presence', number: 5 },
    { title: 'Happy Customers', number: 200 },
  ];
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 my-11 p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] ">
