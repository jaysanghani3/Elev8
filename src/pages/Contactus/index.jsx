    ...
    return (
        <div className='bg-cover flex justify-center items-center flex-col bg-slate-300'>
            ...
            <div className="lg:flex justify-center items-center py-4 lg:py-10 mx-3 lg:w-full">
                ...
                {isLodding ?
                    (
                        <div className='flex justify-center items-center lg:w-4/12 w-[350px] rounded-2xl bg-white h-[555px] lg:h-[610px]'>
                            <div className='animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-gray-900'></div>
                        </div>
                    ) : (
                        <div className='lg:px-10 px-5 py-8 font-semibold lg:py-12 bg-white rounded-2xl lg:w-4/12 md:w-[600px] w-[350px]' >
                            <h1 className='text-2xl lg:text-4xl mb-7 lg:mb-12 font-bold tracking-wider border-b-2'>Contact</h1>
                ...
                <div className='my-5 p-2 lg:p-0 lg:py-3 lg:pr-3 bg-gray-800 h-[550px] rounded-2xl lg:rounded-l-none lg:w-5/12'>
                    <iframe
