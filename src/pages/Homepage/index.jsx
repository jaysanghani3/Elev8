...
import { C0, C1, C2, C3, C4, abus } from "../../assets";
...
const Homepage = () => (
  <div className="container mx-auto px-4">
    ...
    <div className="flex">
      <div className="md:w-8/12 md:p-10 mb-7">
        <Carousel slides={[C0, C1, C2, C3, C4]} height={"h-[250px] md:h-[540px]"} />
      </div>
      <div className="w-4/12 md:flex hidden flex-col justify-center">
        ...
        <Link to="/aboutus" className="bg-[#01204E] text-white px-4 py-2 rounded-lg self-end">
          About Us
        </Link>
      </div>
    </div>
