...
const Aboutus = () => (
    <>
        <div className='bg-[#F6F9FC] flex flex-col lg:flex-row py-10 px-5 lg:px-12 justify-between items-center '>
            ...
            <img src={A1} alt='about1img' className='lg:w-[400px] xl:w-[550px] mt-5 lg:mt-0 lg:ms-6 rounded-lg' />
        </div>
        <div className='bg-white flex justify-center py-10  lg:px-12 px-5 flex-col'>
            <div className='flex justify-between flex-col lg:flex-row items-center'>
                <img src={C3} alt='about1img' className='lg:w-[400px] xl:w-[550px] rounded-lg order-2 lg:order-1 my-6' />
                <div className='flex flex-col order-1 lg:order-2 lg:ms-10'>
            ...
            <div className='flex justify-between flex-col lg:flex-row items-center'>
                <div className='flex flex-col my-10 lg:me-7'>
                ...
                <img src={C4} alt='about1img' className='lg:w-[400px] xl:w-[550px] rounded-lg' />
            </div>
        </div>
        <Certificate />
    </>
