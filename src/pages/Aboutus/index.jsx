...
const Aboutus = () => (
    <>
        <div className='bg-[#F6F9FC] flex flex-col md:flex-row py-10 px-5 sm:px-14 md:px-10 justify-between items-center md:items-center  '>
            ...
            <img src={A1} alt='about1img' className='w-[550px] sm:w-[450px] md:w-[350px] lg:w-[500px] mt-5  md:mt-0 md:ms-6 rounded-md' loading='lazy'/>
        </div>
        <div className='bg-white flex justify-center  py-10 sm:px-14  md:px-10 px-5 flex-col'>
            <div className='flex justify-between flex-col md:flex-row items-center'>
                <img src={C3} alt='about1img' className='w-[550px] sm:w-[450px] md:w-[350px] lg:w-[500px] rounded-md order-2 md:order-1 my-6' loading='lazy'/>
            ...
            <div className='flex justify-between flex-col md:flex-row items-center '>
                ...
                <img src={C4} alt='about1img' className='w-[550px] sm:w-[450px] md:w-[350px] lg:w-[500px] rounded-md' loading='lazy'/>
            </div>
        </div>
        <Certificate />
        ...
        <div className='flex justify-center items-center flex-col x:flex-row xl:flex-row  px-4 md:px-16 py-10'>
            <img src={corevalues} alt='innovation' className='w-[500px]  md:mr-10' loading='lazy'/>
        ...
        <div className='flex flex-col py-10 md:px-10 lg:px-16 px-8 bg-[#F6F9FC] '>
            ...
            <div className='flex lg:flex-row flex-col-reverse  justify-center items-center md:pt-8 '>
                ...
                <img src={sdg8} alt='SDG8' className='w-[550px] sm:w-[380px] md:w-[480px]  my-4  md:mt-0 md:ms-5 rounded-md' loading='lazy'/>
            </div>
        ...
        <div className='flex flex-col py-10  md:px-10 lg:px-16 px-8 bg-[#F6F9FC]'>
            ...
            <div className='flex flex-col-reverse lg:flex-row justify-center items-center md:pt-8 '>
                ...
                <img src={sdg9} alt='SDG9' className='w-[550px] sm:w-[380px] md:w-[480px]  my-4  md:mt-0 md:ms-5 rounded-md' loading='lazy'/>
            </div>
